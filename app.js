...
function layout(){
  document.querySelector('#brand').innerHTML = `<svg class="brand-symbol" viewBox="0 0 210 210" aria-hidden="true" focusable="false"><g fill="none" stroke="currentColor" stroke-width="5.5" stroke-linejoin="round"><path d="M105 8 192 56v98l-87 48-87-48V56Z"/><path d="M105 37 165 72v66l-60 35-60-35V72Z"/><path d="M105 8 45 72M105 8l60 64M192 56l-27 16M192 154l-27-16M105 202l-60-64M105 202l60-64M18 154l27-16M18 56l27 16"/><path d="M45 72 18 154M165 72l27 82M45 138l60 35 60-35"/></g><circle cx="105" cy="105" r="30" fill="currentColor"/></svg><span class="brand-wordmark">Aura<br>Robotics</span><span class="brand-handwritten">Autonomous intelligence<br>makes life better.</span>`;
...
function home(){
  ...
  return `<section class="hero home-hero"><div class="hero-content"><div class="eyebrow">AURA ROBOTICS <span> / </span> ${esc(config.region)}</div><h1>Make room for better work.</h1><p>Commercial service robots for the places people clean, serve and move through every day. Explore the KEENON range with local guidance from AURA Robotics.</p><div class="hero-actions">${button('Explore robots','#/products')}${button('Talk with us','#/contact',true)}</div><div class="hero-index"><span>SMARTER SPACES START HERE</span><span>CLEANING · DELIVERY · SERVICE</span></div></div><div class="hero-art home-hero-art"><div class="hero-grid"></div><div class="home-hero-glow"></div><span class="home-hero-label">MEET THE NEXT SHIFT</span><img src="${esc(pick('C40').image)}" alt="KEENON KLEENBOT C40 floor cleaning robot" fetchpriority="high" decoding="async"><a class="home-hero-link" href="#/products/C40"><span>KLEENBOT C40</span><span>Explore model ↗</span></a></div></section>
